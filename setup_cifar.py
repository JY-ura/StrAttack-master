...
def load_batch(fpath):
    ...
    return np.array(images,dtype=np.float32),np.array(labels)  #fix a bug here add dtype
...
class CIFAR:
    def __init__(self):
        ...
        for i in range(5):
            r,s = load_batch("cifar/data_batch_"+str(i+1)+".bin")
            train_data.extend(r)
        ...
        self.test_data, self.test_labels = load_batch("cifar/test_batch.bin")
